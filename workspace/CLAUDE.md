...
| **eli5** | `.claude/skills/eli5/SKILL.md` | One sentence, deliberately: explain something to someone who knows nothing about it, as an HTML page with big pictures and few words. No steps, no checklist — expanding it is the change that breaks it. | Say "eli5" / "explain like I'm 5" / "dumb it down" |
| **explain1min** | `.claude/skills/explain1min/SKILL.md` | One-minute explainer diagram: a system or process as a self-contained HTML page — at most 3 flow diagrams, under 1000 words, and a decision diamond wherever the flow branches. Same folder: `templates/skeleton.html` (the layout to copy rather than start blank). Narrow on purpose: a single function or term gets an answer in words, not a diagram. | Say "explain how this works" / "draw me a diagram" |
