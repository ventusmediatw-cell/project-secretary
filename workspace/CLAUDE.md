...
4. Project mode requires additionally reading `projects/{name}/INDEX.md` (+ `SYSTEM.md` if exists)
...
|---|---|
| Cowork | `/sessions/.../mnt/【workspace folder】/` |
| Claude Code | `~/【your-repo】/workspace/` |
