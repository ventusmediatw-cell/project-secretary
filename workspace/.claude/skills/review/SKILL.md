...
1. Write project daily report `projects/{name}/daily/YYYY-MM-DD.md`
...
12. **Secretary journal** → `inbox/YYYY-MM-DD.md`
13. **Project daily report** → `projects/{name}/daily/YYYY-MM-DD.md`
