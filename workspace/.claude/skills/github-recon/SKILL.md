...
- **`refs/security-checklist.md`**: Full 7-dimension security checklist. github-recon is its "quick version" + GitHub-specialized. High-importance tool evaluations should still run full checklist after github-recon.
