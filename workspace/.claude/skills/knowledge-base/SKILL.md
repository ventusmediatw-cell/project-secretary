---
name: knowledge-base
description: "Personal knowledge base pipeline: article URL or YouTube URL → fetch full text/subtitles → summarize → archive to knowledge-base/. Includes synthesis layer, project knowledge bridging, book ingestion, and health checks."
---
...
- Manual processing of items in `knowledge-base/inbox/fetch-queue.md`
...
Based on content + user_note, try to match existing project names from INDEX.md, fill into Metadata. If unsure, leave empty.
...
### Fetch Subtitles
```bash
python3 knowledge-base/scripts/fetch_youtube.py <URL>
```
...
Read `knowledge-base/inbox/fetch-queue.md` "Pending" section:
...
### File Location
`projects/{project-name}/refs/kb-digest.md`
...
Location: `knowledge-base/log.md`
...
> Details in `knowledge-base/refs/model-routing.md`.
...
### Search Tool
```bash
python3 knowledge-base/scripts/search_kb.py <query> [options]
```
...
| Purpose | Path |
|---|---|
| Article storage | `knowledge-base/articles/` |
| Video storage | `knowledge-base/videos/` |
| Synthesis pages | `knowledge-base/synthesis/` |
| KB index | `knowledge-base/wiki.md` |
| Historical archive | `knowledge-base/wiki-archive.md` |
| Operation log | `knowledge-base/log.md` |
| Project digest | `knowledge-base/projects-digest.md` |
| Pending queue | `knowledge-base/inbox/fetch-queue.md` |
| Search script | `knowledge-base/scripts/search_kb.py` |
| Wiki generator | `knowledge-base/scripts/gen_wiki.py` |
| YouTube script | `knowledge-base/scripts/fetch_youtube.py` |
| Health check | `knowledge-base/health-check/` |
| Article template | `knowledge-base/articles/_TEMPLATE.md` |
| Video template | `knowledge-base/videos/_TEMPLATE.md` |
