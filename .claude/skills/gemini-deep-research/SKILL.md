...
- Config file: `workspace/gemini-keys.json`
- Currently **3** Keys
...
|---|---|---|
| **KB (sole original)** | `workspace/knowledge-base/articles/YYYY-MM-DD-{slug}.md` | Deep Research raw report, with KB standard frontmatter |
...
| Research Brief (handoff) | `workspace/handoff/pending/YYYY-MM-DD-{topic}-research.md` | Cowork only, research questions and instructions |
